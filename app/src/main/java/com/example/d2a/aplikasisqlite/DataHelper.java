...
class DatabaseHelper extends SQLiteOpenHelper {
    ...
    public static final String COL_2 = "nama barang";
    public static final String COL_3 = "total";
    public static final String COL_4 = "kondisi";
...
//db.execSQL("create table table_krs(kode integer primary key autoincrement," +
    ...
    public boolean insertData(String kode,String name_barang, String
            total, String kondisi) {
        SQLiteDatabase db = this.getWritableDatabase();
        ContentValues contentValues = new ContentValues();
        contentValues.put(COL_1,kode);
        contentValues.put(COL_2,name_barang);
        contentValues.put(COL_3,total);
        contentValues.put(COL_4,kondisi);
    ...
    public boolean updateData(String kode,String nama_barang,String
            total,String kondisi) {
        SQLiteDatabase db = this.getWritableDatabase();
        ContentValues contentValues = new ContentValues();
        contentValues.put(COL_1,kode);
